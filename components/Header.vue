...
<template>
  <header class="h-32 flex items-center justify-between w-full top-0 p-2">
    ...
    <div v-if="search" class="flex flex-1">
      <div class="grid place-items-center w-full" @click="openOverlay">
        <button id="search"
                class="flex justify-center md:justify-between items-center rounded-full px-5 py-2 background-inversed-transparent text-gray-600 dark:text-gray-400 xl:w-1/3">
